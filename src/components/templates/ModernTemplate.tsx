...
interface ModernTemplateProps {
  data: any;
  onUpdate?: (section: string, field: string | any, value?: string | any, index?: number) => void;
  isEditing?: boolean;
  isPDFMode?: boolean;
  sectionOrder?: string[];
...
const ModernTemplate = ({ data, onUpdate, isEditing = false, isPDFMode = false, activeSection, sectionOrder }: ModernTemplateProps) => {
